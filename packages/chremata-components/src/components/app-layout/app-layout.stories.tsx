...
function App() {
  ...
  function renderHeader() {
    return <Banner>
      <Label size="xlarge" variant="emphasis">Dashboard</Label>
    </Banner> 
  }
  ...
  function renderMainLayout() {
    return (
      <GridLayout
        ...
        columnGap='panel'
        padding='medium'>
          <GridLayout.Area areaName="card-left" padding="small">
            <Card title="Expenses">
              <Card.Header />
          ...
          <GridLayout.Area areaName="card-right" padding="small">
            <Card title="Revenues">
              <Card.Header />
          ...
          <GridLayout.Area areaName="table" padding="small">
            <Card title="Transactions">
              <Card.Header />

              <Card.Body>
                <Table caption="Transactions" columns={columns} data={data}/>
              </Card.Body>
            </Card>
          </GridLayout.Area>
      </GridLayout>
