...
test(
  'should render an ActionList with no actions',
  { tag },
  async ({ mount, page }) => {
    const actionList = await mount(<ActionList></ActionList>);
...
test(
  'should render an ActionList with one action',
  { tag },
  async ({ mount, page }) => {
...
test(
  'should render an ActionList with multiple actions',
  { tag },
  async ({ mount, page }) => {
    const actionList = await mount(
      <ActionList>
...
test(
  'should render an ActionList with a disabled action',
  { tag },
  async ({ mount, page }) => {
    const actionList = await mount(
      <ActionList>
